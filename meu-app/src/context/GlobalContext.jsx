...
export function GlobalProvider({ children }) {
    ...
    async function carregarItens() {
        dispatch({ type: actuonTypes.SET_LOADING, payload: true });
        try {
    ...
    async function adicionarItem(itemp) {
        try {
    ...
    return (
        <GlobalContext.Provider value={{ state, dispatch, adicionarItem, carregarItens }}>
            {children}
